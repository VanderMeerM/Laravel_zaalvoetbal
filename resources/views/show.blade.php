...
<div class="flex items-center justify-center mt-2 bg-black p-7 w-80 m-auto">
 ...
 <input 
 class="block w-24 m-4 rounded-md bg-orange-500 px-3 py-5 text-center text-6xl text-gray-900 outline -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6"
 ...
 <input 
class="block w-24 rounded-md bg-yellow-300 px-3 py-5 text-center text-gray-900 outline outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6"
